...
function loadManualCharacterCosts() {
  characterCostMap = {
    ...
    Kazuha: ["Anemo", 5, "Sword", 8],
    Sucrose: ["Anemo", 4, "Catalyst", 8],
    Chasca: ["Anemo", 5, "Bow", 8],
    LanYan: ["Anemo", 4, "Catalyst", 6],
    Venti: ["Anemo", 5, "Bow", 6],
    ...
    Lauma: ["Dendro", 5, "Catalyst", 12],
    Nahida: ["Dendro", 5, "Catalyst", 8],
    Nefer: ["Dendro", 5, "Catalyst", 8],
    Kinich: ["Dendro", 5, "Claymore", 8],
    Alhaitham: ["Dendro", 5, "Sword", 6],
    // TravelerDendro: ["Dendro", 5, "Sword", 6],
    Emilie: ["Dendro", 5, "Polearm", 6],
    Baizhu: ["Dendro", 5, "Catalyst", 6],
    Tighnari: ["Dendro", 5, "Bow", 4],
    ...
    HuTao: ["Pyro", 5, "Polearm", 6],
    Lyney: ["Pyro", 5, "Bow", 6],
    Gaming: ["Pyro", 4, "Claymore", 6],
